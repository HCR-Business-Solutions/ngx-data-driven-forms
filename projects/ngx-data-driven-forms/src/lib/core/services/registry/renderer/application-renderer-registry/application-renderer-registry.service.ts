...
import { RenderApplicationBaseComponent } from '../../../../components/renderer-bases';

type REGISTRY_KEY = string;
type REGISTRY_VALUE = Type<RenderApplicationBaseComponent>;
type REGISTRY = Map<REGISTRY_KEY, REGISTRY_VALUE>;
const DEFAULT_REGISTRY: REGISTRY = new Map<REGISTRY_KEY, REGISTRY_VALUE>();

@Injectable()
export class ApplicationRendererRegistryService {
